...
public class PolygonPrimitive extends MacroPrimitive {

  private static final String cvsid =
  "$Id: PolygonPrimitive.java,v 1.1.1.1 2004/06/24 05:46:01 vona Exp $";


  public PolygonPrimitive(final List<MacroExpression> exprs) {
    super(exprs);
  }
  ...
  protected PrimitiveInstance getInstanceInternal(final List<Double> actuals) {
    ...
    double diameter = getParam(i++, actuals);

    double rotation = getParam(i++, actuals);

    return new PolygonInstance(n, x, y, diameter, rotation);
  }
