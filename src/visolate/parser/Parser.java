...
public class Parser implements ParserConstants {
  ...
  final public void Input() throws ParseException {boolean stop = false;
    label_1:
    while (true) {
...
if (stop) {if ("" != null) return;}
  ...
  final public boolean Code() throws ParseException {int stop = -1;
  Token seq = null;
  Token t;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case 20:{
...
{if ("" != null) return (stop == HALT) ||
  ...
  final public void GCode() throws ParseException {Token txt;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case 21:{
      jj_consume_token(21);
...
simulator.setIncremental(true);
  ...
  final public void DCode() throws ParseException {boolean flash = false;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case 38:
    case 39:
    case 40:
...
if (flash)
  ...
  final public void CoordinateDCode() throws ParseException {String[] c = new String[4];
    Coordinates(c);
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case 34:
    case 35:
...
if ((c[2] != null) || (c[3] != null))
  ...
  final public boolean NonCoordinateDCode() throws ParseException {Token aperture = null;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case 34:{
      jj_consume_token(34);
      switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
...
simulator.setAperture(Integer.parseInt(aperture.image));
  ...
  final public String Coord() throws ParseException {Token sign = null, digits;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case SIGN:{
...
{if ("" != null) return ((sign != null) ? sign.image : "") + digits.image;}
    throw new Error("Missing return statement in function");
}

  final public double Double() throws ParseException {Token sign = null, digitsBefore = null, digitsAfter = null;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case SIGN:{
      sign = jj_consume_token(SIGN);
      break;
...
{if ("" != null) return HALT;}
  ...
  final public void InputEncoding() throws ParseException {Token e;
    jj_consume_token(46);
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case 47:{
...
if (!"AS".equals(e.image) && !"IS".equals(e.image))
  ...
  final public void AxisSelect() throws ParseException {Token a, b;
    jj_consume_token(47);
    jj_consume_token(52);
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case 38:{
...
System.err.println(
  ...
  final public void FormatStatement() throws ParseException {Token ignore, mode, fmt;
    jj_consume_token(54);
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case 55:
    case 56:{
...
if (fmt.image.length() != 2) {
  ...
  final public void ImageName() throws ParseException {Token name;
    jj_consume_token(IN);
...
System.out.println("image name: " + name.image);
  ...
  final public void ImagePolarity() throws ParseException {Token polarity;
    jj_consume_token(60);
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case 61:{
...
System.err.println("WARNING: ignoring image polarity IP" + polarity.image);
  ...
  final public void LayerName() throws ParseException {Token name;
    jj_consume_token(LN);
    name = jj_consume_token(TEXT);
    jj_consume_token(CODE_DELIM);
System.out.println("layer name: " + name.image);
  ...
  final public void LayerPolarity() throws ParseException {Token polarity;
    jj_consume_token(63);
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case 64:{
...
System.err.println("WARNING: ignoring layer polarity LP" + polarity.image);
  ...
  final public void Mode() throws ParseException {Token mode;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case 65:{
...
if ("MOMM".equals(mode.image)) simulator.setMetric();
  ...
  final public void Offset() throws ParseException {double a = Double.NaN, b = Double.NaN;
    jj_consume_token(67);
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case 52:{
      jj_consume_token(52);
...
System.err.println("WARNING: ignoring offset OF" +
  ...
  final public void ScaleFactor() throws ParseException {double a = Double.NaN, b = Double.NaN;
    jj_consume_token(68);
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case 52:{
      jj_consume_token(52);
...
System.err.println("WARNING: ignoring scale factor SF" +
  ...
  final public void StepAndRepeat() throws ParseException {Token x = null;
  Token y = null;
  double i = Double.NaN;
  double j = Double.NaN;
    jj_consume_token(69);
...
System.err.println("WARNING: ignoring step and repeat SR" +
  ...
  final public void ApertureDescription() throws ParseException {Token number;
  Token typeToken;
...
int num = Integer.parseInt(number.image);
  ...
  final public void ModifierList(List list) throws ParseException {double modifier;
    modifier = Double();
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case 38:{
      jj_consume_token(38);
...
list.add(0, new Double(modifier));
  ...
  final public void ApertureMacro() throws ParseException {Token name;
...
simulator.addMacro(new Macro(name.image, primitives));
  ...
  final public void PrimitiveList(List primitives) throws ParseException {MacroPrimitive primitive;
    primitive = Primitive();
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case CODE_DELIM:
    case DIGITS:{
...
if (primitive != null)
  ...
  final public MacroPrimitive Primitive() throws ParseException {List exprs = new LinkedList();
  Token numberToken;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case CODE_DELIM:{
      jj_consume_token(CODE_DELIM);
...
int primitiveNumber = Integer.parseInt(numberToken.image);
    ...
    case 1: {if ("" != null) return new CirclePrimitive(exprs);}
    case 2: {if ("" != null) return new LineVectorPrimitive(exprs);}
    case 20: {if ("" != null) return new LineVectorPrimitive(exprs);}
    case 21: {if ("" != null) return new LineCenterPrimitive(exprs);}
    case 22: {if ("" != null) return new LineLLPrimitive(exprs);}
    case 3: {if ("" != null) return null;}
    case 4: {if ("" != null) return new OutlinePrimitive(exprs);}
    case 5: {if ("" != null) return new PolygonPrimitive(exprs);}
    case 6: {if ("" != null) return new MoirePrimitive(exprs);}
    case 7: {if ("" != null) return new ThermalPrimitive(exprs);}
    default:
  ...
  final public void ExprList(List exprs) throws ParseException {MacroExpression expr;
    expr = Expr();
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case 70:{
      jj_consume_token(70);
...
exprs.add(0, expr);
  ...
  final public MacroExpression Expr() throws ParseException {MacroExpression lhs = null;
...
if (rhs == null)
    ...
    {if ("" != null) return new MacroBinOp((("+".equals(op.image)) ?
                           MacroBinOp.ADD : MacroBinOp.SUBTRACT),
                          lhs, rhs);}
    throw new Error("Missing return statement in function");
}

  final public MacroExpression MulExpr() throws ParseException {MacroExpression lhs = null;
  MacroExpression rhs = null;
  Token op = null;
    lhs = UnaryExpr();
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
...
if (op == null)
    ...
    {if ("" != null) return new MacroBinOp(operator, lhs, rhs);}
    throw new Error("Missing return statement in function");
}

  final public MacroExpression UnaryExpr() throws ParseException {double value;
  Token index;
    switch ((jj_ntk==-1)?jj_ntk_f():jj_ntk) {
    case SIGN:
    case DIGITS:
    case 42:{
      value = Double();
{if ("" != null) return new MacroConstant(value);}
      break;
      }
    case 73:{
      jj_consume_token(73);
      index = jj_consume_token(DIGITS);
{if ("" != null) return new MacroVariable(Integer.parseInt(index.image));}
      break;
      }
    default:
      jj_la1[57] = jj_gen;
